...
;						if ($stop->country=='Cuba') {
						...
						$content = Utils::file_get_contents_curl("https://www.mapquestapi.com/staticmap/v5/map?key=Ut3gS9mkk5cmm8gcaynC3dykGc7eA2gu&center={$stop->lat},{$stop->long}&size=300,300@2x");
